...
struct printer
{
    static void print_impl (Stream& os, const T& val)
    {
...
struct qbiq
{
    ...
    static void T_construct (Stream& os, const T& val, std::index_sequence<I...>)
    {
    ...
    { 
        static void f(Stream& os, const T& val) {}
    };
...
void print_impl (Stream& out, const T& obj, std::index_sequence<I...>)
{
